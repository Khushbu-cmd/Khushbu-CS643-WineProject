...
model = RandomForestModel.load(sc, "s3://aws-logs-354044808805-us-east-1/Trainmodel/")
print(model)


Dframe = SContext.read.format('com.databricks.spark.csv').options(header='true', inferschema='true', sep=';').load('s3://aws-logs-354044808805-us-east-1/ValidationDataset.csv')
